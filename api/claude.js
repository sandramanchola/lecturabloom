// api/claude.js — Proxy serverless de Vercel
// La ANTHROPIC_API_KEY vive SOLO aquí en el servidor (variable de entorno de Vercel).
// El frontend nunca la ve ni la toca.
