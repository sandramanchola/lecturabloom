...
const T = {
  es: {
    ...
    q_system:`Eres especialista en Taxonomía de Bloom y STAAR de Texas. Genera 6 preguntas de opción múltiple en ESPAÑOL, una por nivel Bloom, estilo STAAR: lenguaje académico preciso, stem con contexto textual, 4 opciones plausibles, tipos: idea principal, inferencia, vocabulario en contexto, estructura, propósito del autor. Sin "todas las anteriores". SOLO JSON válido sin backticks.`,
  ...
  en: {
    ...
    q_system:`You are a specialist in Bloom's Taxonomy and the Texas STAAR exam. Generate 6 multiple-choice questions in ENGLISH, one per Bloom level, STAAR style: precise academic language, stem with text context, 4 plausible choices, types: main idea, inference, vocabulary in context, text structure, author's purpose. No "all of the above". ONLY valid JSON no backticks.`,
